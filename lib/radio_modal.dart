...
class RadioModal extends StatefulWidget {
  @override
  RadioModalState createState() => RadioModalState();
}

class RadioModalState extends State<RadioModal> with SingleTickerProviderStateMixin {
  GlobalKey<ScaffoldState> radioModalScaffoldKey;
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: RawMaterialButton(
                        elevation: commentIsSent ? 2 : 0,
                        fillColor: commentIsSent
                            ? Theme.of(context).primaryColor
                            : Theme.of(context).disabledColor,
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(5),
                        ),
                        onPressed: commentIsSent
                            ? () {
                                sendMail();
                              }
                            : null,
  ...
  void initState() {
    ...
    radioModalScaffoldKey = GlobalKey<ScaffoldState>();
          ...
          child: Column(
            ...
            children: <Widget>[
              Stack(
                ...
                children: <Widget>[
                  Image.asset('assets/images/poster_' +
