...
class PrayerViewModal extends StatefulWidget {
  final Prayer prayer;

  PrayerViewModal({Key key, @required this.prayer}) : super(key: key);

  @override
  PrayerViewModalState createState() => PrayerViewModalState();
}

class PrayerViewModalState extends State<PrayerViewModal> with SingleTickerProviderStateMixin {
